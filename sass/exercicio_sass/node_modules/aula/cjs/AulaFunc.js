...
function () {
  ...
  _createClass(AulaFunc, [{
    ...
    key: "mediaGet",
    value: function mediaGet(loc) {
      return (0, _AXR.default)(this.tunnel, ['mediaGet', '/servers/:server_id/media/:media_id', 'GET'], loc);
    }
    /**
     * Upload Media
     * Upload media
    ...
    key: "collectionExport",
    value: function collectionExport(loc) {
      return (0, _AXR.default)(this.tunnel, ['collectionExport', '/servers/:server_id/collections/:collection_id/export', 'GET'], loc);
    }
    /**
     * Collection Import
    ...
    key: "collectionImport",
    value: function collectionImport(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['collectionImport', '/servers/:server_id/collection_import', 'POST'], loc, body);
    }
    /**
     * Media Analysis
     * Get media analysis
    ...
    key: "userUpload",
    value: function userUpload(body) {
      return (0, _AXR.default)(this.tunnel, ['userUpload', '/my/upload/:type', 'POST'], {}, body);
    }
    /**
     * Delete Media
     * Delete media
    ...
    key: "courseGet",
    value: function courseGet() {
      return (0, _AXR.default)(this.tunnel, ['courseGet', '/servers/:server_id/course/:collection_id', 'GET'], {});
    }
    /**
     * Search Articles
    ...
    key: "articleRender",
    value: function articleRender(body) {
      return (0, _AXR.default)(this.tunnel, ['articleRender', '/servers/:server_id/collections/:collection_id/articles/:article_id/render', 'POST'], {}, body);
    }
    /**
     * Delete Article
    ...
    key: "articlePrune",
    value: function articlePrune(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['articlePrune', '/servers/:server_id/articles/:article_id/prune', 'PUT'], loc, body);
    }
    /**
    ...
    value: function articleSegmentAutocut(body) {
      return (0, _AXR.default)(this.tunnel, ['articleSegmentAutocut', '/servers/:server_id/collections/:collection_id/articles/:article_id/segments/:seg_id/autocut', 'POST'], {}, body);
    }
    /**
    ...
    key: "postReport",
    value: function postReport(body) {
      return (0, _AXR.default)(this.tunnel, ['postReport', '/servers/:server_id/posts/:post_id/report', 'POST'], {}, body);
    }
    /**
     * Modify Post
     * Modify post
    ...
    value: function postSelectAnswer(body) {
      return (0, _AXR.default)(this.tunnel, ['postSelectAnswer', '/servers/:server_id/posts/:post_id/correct', 'PUT'], {}, body);
    }
    /**
     * Delete Post
     * Delete post
    ...
    key: "addLocale",
    value: function addLocale(body) {
      return (0, _AXR.default)(this.tunnel, ['addLocale', '/locales/add/:lang/:ns', 'POST'], {}, body);
    }
    /**
     * Modify Server
     * Modify server info
    ...
    value: function userNotificationTokenSet(body) {
      return (0, _AXR.default)(this.tunnel, ['userNotificationTokenSet', '/my/:device_id/token', 'PUT'], {}, body);
    }
    /**
    ...
    value: function serverNotificationSend(body) {
      return (0, _AXR.default)(this.tunnel, ['serverNotificationSend', '/servers/:server_id/notification', 'POST'], {}, body);
    }
    /**
    ...
    key: "serverUserMark",
    value: function serverUserMark(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserMark', '/servers/:server_id/mark', 'POST'], loc, body);
    }
    /**
     * Clear User Touch
    ...
    value: function serverUserTouchClear(body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserTouchClear', '/servers/:server_id/touch/:type/:id/clear', 'PUT'], {}, body);
    }
    /**
     * Leave User Touch
    ...
    value: function serverUserBanPut(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserBanPut', '/servers/:server_id/bans/:user_id', 'PUT'], loc, body);
    }
    /**
    ...
    key: "serverUserAdd",
    value: function serverUserAdd(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserAdd', '/servers/:server_id/users_add', 'PUT'], loc, body);
    }
    /**
     * Add Server User Id
    ...
    key: "serverUserAddId",
    value: function serverUserAddId(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserAddId', '/servers/:server_id/users_add_id', 'PUT'], loc, body);
    }
    /**
     * Modify Server User
     * Modify server user
    ...
    value: function serverUserItemAdd(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserItemAdd', '/servers/:server_id/users/:user_id/items/:item_id/add', 'POST'], loc, body);
    }
    /**
    ...
    value: function serverUserCollectionAccessModify(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserCollectionAccessModify', '/servers/:server_id/users/:user_id/access/:collection_id', 'POST'], loc, body);
    }
    /**
    ...
    value: function serverUserRolePut(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['serverUserRolePut', '/servers/:server_id/users/:user_id/roles/:role_id', 'PUT'], loc, body);
    }
    /**
    ...
    value: function serverModuleMove(body) {
      return (0, _AXR.default)(this.tunnel, ['serverModuleMove', '/servers/:server_id/collections/:collection_id/modules_move', 'PUT'], {}, body);
    }
    /**
     * Move Collection
    ...
    value: function serverCollectionBuy(body) {
      return (0, _AXR.default)(this.tunnel, ['serverCollectionBuy', '/servers/:server_id/collections/:collection_id/buy', 'POST'], {}, body);
    }
    /**
     * Get Collection
    ...
    value: function userClaimLostPass(body) {
      return (0, _AXR.default)(this.tunnel, ['userClaimLostPass', '/users/claim_lost_pass', 'POST'], {}, body);
    }
    /**
    ...
    key: "articleRebuild",
    value: function articleRebuild(loc, body) {
      return (0, _AXR.default)(this.tunnel, ['articleRebuild', '/servers/:server_id/articles/:article_id/rebuild', 'PUT'], loc, body);
    }
    /**
     * Dump Server
