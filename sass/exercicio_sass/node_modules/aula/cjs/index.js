...
var Aula = function Aula() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      user = _ref.user,
      _ref$host = _ref.host,
      host = _ref$host === void 0 ? "nightly.aula.bg" : _ref$host,
  ...
  if (socket) {
    ...
    tunnel.send = function (func, data) {
      ...
      if (data.body && ["POST", "PUT", "PATCH"].indexOf(extra.method) !== -1) {
        ...
        } else if (data.body && data.body.constructor && data.body.constructor.name === "ReadStream") {
          extra.body = data.body; //extra.headers["Content-Type"] = "application/octet-stream";
        } else {
      ...
      return ref_fetch(url, extra).then(function (response) {
        var cp = response.headers.get("content-disposition");

        if (cp && cp.indexOf("attachment") !== -1) {
          return response;
        }
